...
(* CORE_GENERATION_INFO = "zynq,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_bram_cntlr_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zynq.hwdef" *) 
module zynq
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  assign LEDS[7:0] = gpio_lab_1_0_LEDS;
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > zynq blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  zynq_axi_bram_ctrl_0_1 axi_bram_ctrl_0
  ...
  zynq_axi_bram_ctrl_1_0 axi_bram_ctrl_1
  ...
  zynq_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  zynq_gpio_lab_1_0_1 gpio_lab_1_0
       (.LEDS(gpio_lab_1_0_LEDS),
        .s00_axi_aclk(Net),
  ...
  zynq_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr[14:0]),
        ...
        .S_AXI_HP0_ACLK(Net),
        .S_AXI_HP0_ARADDR(smartconnect_1_M01_AXI_ARADDR),
        .S_AXI_HP0_ARBURST(smartconnect_1_M01_AXI_ARBURST),
        .S_AXI_HP0_ARCACHE(smartconnect_1_M01_AXI_ARCACHE),
        .S_AXI_HP0_ARID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_ARLEN(smartconnect_1_M01_AXI_ARLEN),
        .S_AXI_HP0_ARLOCK(smartconnect_1_M01_AXI_ARLOCK),
        .S_AXI_HP0_ARPROT(smartconnect_1_M01_AXI_ARPROT),
        .S_AXI_HP0_ARQOS(smartconnect_1_M01_AXI_ARQOS),
        .S_AXI_HP0_ARREADY(smartconnect_1_M01_AXI_ARREADY),
        .S_AXI_HP0_ARSIZE(smartconnect_1_M01_AXI_ARSIZE),
        .S_AXI_HP0_ARVALID(smartconnect_1_M01_AXI_ARVALID),
        .S_AXI_HP0_AWADDR(smartconnect_1_M01_AXI_AWADDR),
        .S_AXI_HP0_AWBURST(smartconnect_1_M01_AXI_AWBURST),
        .S_AXI_HP0_AWCACHE(smartconnect_1_M01_AXI_AWCACHE),
        .S_AXI_HP0_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_AWLEN(smartconnect_1_M01_AXI_AWLEN),
        .S_AXI_HP0_AWLOCK(smartconnect_1_M01_AXI_AWLOCK),
        .S_AXI_HP0_AWPROT(smartconnect_1_M01_AXI_AWPROT),
        .S_AXI_HP0_AWQOS(smartconnect_1_M01_AXI_AWQOS),
        .S_AXI_HP0_AWREADY(smartconnect_1_M01_AXI_AWREADY),
        .S_AXI_HP0_AWSIZE(smartconnect_1_M01_AXI_AWSIZE),
        .S_AXI_HP0_AWVALID(smartconnect_1_M01_AXI_AWVALID),
        .S_AXI_HP0_BREADY(smartconnect_1_M01_AXI_BREADY),
        .S_AXI_HP0_BRESP(smartconnect_1_M01_AXI_BRESP),
        .S_AXI_HP0_BVALID(smartconnect_1_M01_AXI_BVALID),
        .S_AXI_HP0_RDATA(smartconnect_1_M01_AXI_RDATA),
        .S_AXI_HP0_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP0_RLAST(smartconnect_1_M01_AXI_RLAST),
        .S_AXI_HP0_RREADY(smartconnect_1_M01_AXI_RREADY),
        .S_AXI_HP0_RRESP(smartconnect_1_M01_AXI_RRESP),
        .S_AXI_HP0_RVALID(smartconnect_1_M01_AXI_RVALID),
        .S_AXI_HP0_WDATA(smartconnect_1_M01_AXI_WDATA),
        .S_AXI_HP0_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_WLAST(smartconnect_1_M01_AXI_WLAST),
        .S_AXI_HP0_WREADY(smartconnect_1_M01_AXI_WREADY),
        .S_AXI_HP0_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP0_WSTRB(smartconnect_1_M01_AXI_WSTRB),
        .S_AXI_HP0_WVALID(smartconnect_1_M01_AXI_WVALID),
        .USB0_VBUS_PWRFAULT(1'b0));
  zynq_smartconnect_0_0 smartconnect_0
  ...
  zynq_smartconnect_1_0 smartconnect_1
