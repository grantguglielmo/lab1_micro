...
HD_PWD='/home/ecelrc/students/gguglielmo/micro/vivado/lab_1/lab_1.runs/zynq_axi_bram_ctrl_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_bram_ctrl_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_bram_ctrl_1_0.tcl
