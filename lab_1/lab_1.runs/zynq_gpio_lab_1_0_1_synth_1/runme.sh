...
HD_PWD='/home/ecelrc/students/gguglielmo/micro/vivado/lab_1/lab_1.runs/zynq_gpio_lab_1_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_gpio_lab_1_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_gpio_lab_1_0_1.tcl
