...
HD_PWD='/home/ecelrc/students/gguglielmo/micro/vivado/lab_1/lab_1.runs/zynq_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_smartconnect_0_0.tcl
